...
class CitizensQuestion < ActiveRecord::Base
  ...
  def paypal_url
    ...
    "https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=otazky_1347886840_biz@gmail.com&item_name=#{values[:item_name]}&amount=#{values[:amount]}&quantity=#{values[:item_quantity]}&currency_code=CZK&return_url=http://www.otazkyprocr.cz/payments/paypal/"
  end
