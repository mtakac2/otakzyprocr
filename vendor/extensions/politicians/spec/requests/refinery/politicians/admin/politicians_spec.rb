    ...
    describe "Admin" do
      describe "politicians" do
        ...
        describe "politicians list" do
          before(:each) do
            FactoryGirl.create(:politician, :name => "UniqueTitleOne")
            FactoryGirl.create(:politician, :name => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:politician, :name => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:politician, :name => "A name") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:politician, :name => "UniqueTitleOne") }
